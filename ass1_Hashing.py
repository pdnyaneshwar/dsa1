            ...
            if choice1 == 2:
                ...
                if comparision < size:
                    print('The number', number, 'is found at location',
                          hashvalue, 'with total comparisions=', comparision+1)
                else:
                    print(
                        'The number is NOT found in the hashtable.... with comparisions', comparision+1)
            if choice1 == 3:
                for i in range(size):
        ...
        while(choice1 != 4):
            ...
            if choice1 == 2:
                ...
                while(hashtable[hashvalue1][0] != number and comparision < size):
                    hashvalue1 = number % size
                    prime = int(
                        input("Enter prime number lesser than size of HASH TABLE : "))
                    hashvalue2 = (prime-(number % prime))
                    hashvalue3 = (hashvalue1 + i * hashvalue2) % size
                    hashvalue1 = hashvalue3
                    comparision += 1
                ...
                if comparision < size:
                    print('The number', number, 'is found at location',
                          hashvalue1, 'with comparisions', comparision+1)
                else:
                    print(
                        'The number is NOT found in the hashtable... with comparisions', comparision+1)
            if choice1 == 3:
